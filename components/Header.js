...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 w-full z-30 clearNav md:bg-opacity-90 transition duration-300 ease-in-out border-b border-gray-800">
      <div className="flex flex-col max-w-6xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
        <div className="flex flex-row items-center justify-between p-4">
          ...
          >
            <h1 className="text-1xl Avenir tracking-tighter text-white md:text-2x1 lg:text-2xl">
              {config.appName}
            </h1>
          </a>
          <button
        ...
        >
          <nav className="flex-col flex-grow ">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              ...
              <li>
                <a
                  className="inline-flex items-center px-3 py-2 mt-2 font-medium text-white transition duration-500 ease-in-out transform bg-transparent rounded-lg bg-gray-900 rounded-full"
